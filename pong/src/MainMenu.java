...
public class MainMenu extends JFrame implements Runnable {
    ...
    public MainMenu() {
        ...
        this.startGame = new Text("Start Game",new Font("Silkscreen",Font.PLAIN,40), Constants.SCREEN_WIDTH / 2.0 - 180.0, Constants.SCREEN_HEIGHT / 2.0, Color.WHITE);
        this.exitGame = new Text("Exit", new Font("Silkscreen", Font.PLAIN,40), Constants.SCREEN_WIDTH / 2.0 - 80.0, Constants.SCREEN_HEIGHT / 2.0 + 60, Color.WHITE);
        this.pong = new Text("Pong, Ping Pong!", new Font("Silkscreen", Font.PLAIN, Constants.TITLE_TEXT_SIZE), Constants.SCREEN_WIDTH / 2.0 - 380.0, 200, Color.WHITE);
